                ...
                foreach ($posts_array as $post) : 
                    ...
                    if ($es_euskera) {
                        ...
                        $nombres_visuales = array(
                            ...
                            'tag-blue'   => 'Uretakoa',
                            'tag-green'  => 'Ekitaldia',
                            'tag-purple' => 'Jokoa' // NUEVO y ultimo agregado, en un principio no deberia de haber mas
                        );
                        ...
                        $nombres_visuales = array(
                            ...
                            'tag-blue'   => 'Acuatico',
                            'tag-green'  => 'Evento',
                            'tag-purple' => 'Juego' // NUEVO y ultimo agregado, en un principio no deberia de haber mas
                            //nos quedamos sin colores
                        );
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function filterProducts(category) {
            ...
            products.forEach(product => {
                // LÓGICA DE FILTRADO
                // El JS no cambia porque el data-filter sigue siendo el slug (uretakoa, acuatico, etc.) IMPORTANTE
