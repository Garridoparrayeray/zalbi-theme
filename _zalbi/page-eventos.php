        ...
        <div class="container options" id="product-grid">
            ...
            if ($query->have_posts()) {
                while ($query->have_posts()) {
                    ...
                    // Cargar campos ACF (Se cargan del idioma correspondiente)
            ...
            <article class="product-card">
                ...
                <div class="card-content">
                    ...
                    <a href="<?php the_permalink(); ?>" class="btn btn-outline" style="width: 100%; text-align: center; margin-bottom: 10px;">
                        <?php echo $t_ver_mas; ?>
                    </a>
