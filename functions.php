...
// Registrar la Taxonomía para el Filtro tipos de hichable
...
// Registrar el Post Type "Evento" (Usando el slug "eventos")(codigo mas sencillo da que englobamos todos los eventos juntos)
...
function zalbi_customize_whatsapp($wp_customize) {
    ...
    $wp_customize->add_section('zalbi_whatsapp_section', array(
        ...
        'priority'    => 120, //sin priotidad saldra abajo del todo de personalizar. Tendria que haberlo metido en el menu principal (Proxima implementacion)
    ));
    ...
    // Crear el campo de texto visible 
